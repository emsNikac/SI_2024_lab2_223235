...
## Every Branch
![Screenshot 2024-05-26 161101](https://github.com/emsNikac/SI_2024_lab2_223235/assets/165374773/17c3773c-c979-4013-ba4c-48baec9cf001)</br>
...
- **Влез**: `allItems = [new Item("item1", "12a45", 100, 0)]`, `payment = 100`
...
- **Влез**: `allItems = [new Item("item1", "012345", 350, 0.1f)]`, `payment = 32`
- **Очекуван резултат**: `true`
...
- **Влез**: `allItems = [new Item("item1", "12345", 100, 0), new Item("item2", "54321", 200, 0.1f), new Item("item3", "67890", 400, 0.2f)]`, `payment = 200`
...
- **Влез**: `allItems = [new Item("item1", "12345", 50, 0)]`, `payment = 60`
- **Очекуван резултат**: `true`
...
- **Влез**: `allItems = [new Item("item1", "12345", 100, 0), new Item("item2", "67890", 200, 0)]`, `payment = 250`
- **Очекуван резултат**: `false`
...
## Multiple condition (влезните случаи се напишани во објаснувањето)
...
- **Влез**: `allItems = [new Item("item1", "012345", 350, 0.1f)]`, `payment = 35`
- **Очекуван резултат**: `true`
...
- **Влез**: `allItems = [new Item("item1", "112345", 350, 0.1f)]`, `payment = 35`
- **Очекуван резултат**: `false`
...
- **Влез**: `allItems = [new Item("item1", "012345", 350, 0.0f)]`, `payment = 35`
- **Очекуван резултат**: `false`
...
- **Влез**: `allItems = [new Item("item1", "112345", 350, 0.0f)]`, `payment = 35`
- **Очекуван резултат**: `false`
...
- **Влез**: `allItems = [new Item("item1", "012345", 250, 0.1f)]`, `payment = 25`
- **Очекуван резултат**: `false`
...
- **Влез**: `allItems = [new Item("item1", "112345", 250, 0.1f)]`, `payment = 25`
- **Очекуван резултат**: `false`
...
- **Влез**: `allItems = [new Item("item1", "012345", 250, 0.0f)]`, `payment = 25`
- **Очекуван резултат**: `false`
...
- **Влез**: `allItems = [new Item("item1", "112345", 250, 0.0f)]`, `payment = 25`
- **Очекуван резултат**: `false`
